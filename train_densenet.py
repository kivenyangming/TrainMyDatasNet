...
from myNets.densenet import DenseNet  # 可更换为 ['DenseNet', 'densenet121', 'densenet169', 'densenet201', 'densenet161']
...
model = DenseNet(num_classes=5)  # 可更换为 ['DenseNet', 'densenet121', 'densenet169', 'densenet201', 'densenet161']
learning_rate = 0.1
batch_size = 64
epochs = 100
